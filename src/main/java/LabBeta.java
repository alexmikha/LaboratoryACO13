...
public class LabBeta {
    public static void main(String[] args) throws RegisterException, IOException {
        ...
        controller.register("Xouse", "Laurie", LocalDate.of(0, 2, 2), "+38093888-88-88", "xouse@gmail.com", "doctor", "doctor", Position.DOCTOR);
        controller.register("Assis", "Assist", LocalDate.of(0, 1, 3), "+38093999-99-99", "assist@gmail.com", "assis", "assis", Position.ASSISTANT);
        DBUtils.save(db);
    }
}
